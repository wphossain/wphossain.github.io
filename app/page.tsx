    ...
    <>
      ...
      <main className="content min-h-screen bg-[#F8FAFC] pb-24 lg:pb-0">
        <div className="content-inner w-full flex flex-col">
          ...
          <section 
            className="w-full bg-[#FFFFFF] flex items-center border-b border-[#CBD5E1] relative overflow-hidden" 
            id="home"
            style={{ 
          ...
          >
            ...
            <div className="absolute top-0 right-0 w-[50%] h-[50%] bg-[radial-gradient(circle,rgba(37,99,235,0.04),transparent_70%)] pointer-events-none" />
            <div className="absolute bottom-0 left-0 w-[50%] h-[50%] bg-[radial-gradient(circle,rgba(37,211,102,0.03),transparent_70%)] pointer-events-none" />
            ...
            <div className="max-w-[var(--container)] mx-auto w-full px-6 lg:px-10 py-14 lg:py-20">
              <div className="hero-grid grid grid-cols-[1.1fr_0.9fr] max-xl:grid-cols-1 gap-10 items-stretch">
                <div className="hero-copy flex flex-col justify-between h-full animate-in fade-in slide-in-from-left-8 duration-700">
                  <div>
                    <span className="eyebrow inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#15803D]/10 border border-[#15803D]/25 text-[#15803D] text-[11px] font-extrabold uppercase tracking-widest mb-7 shadow-sm">
                      <span className="w-2 h-2 rounded-full bg-[#15803D] animate-pulse" />
                      {hero.content_json?.eyebrow_text || 'Available For New Clients'}
                    </span>
                    <h1 className="text-[clamp(32px,4.4vw,54px)] font-display leading-[1.08] mb-6 text-[#1E293B] font-bold tracking-tight">
                      {hero.title}
                    </h1>
                    <p className="text-[17px] text-[#475569] max-w-[620px] leading-relaxed mb-8">
                      {hero.subtitle}
                    </p>
                    <div className="hero-actions flex flex-wrap gap-4 mt-12 mb-2.5 max-sm:flex-col">
                      ...
                      <a className="btn btn-ghost px-8 py-4 text-[15px] font-bold rounded-xl border border-[#CBD5E1] bg-slate-50 text-[#1E293B] hover:bg-slate-100 transition-all flex items-center gap-2 shadow-sm" href={hero.content_json?.cta_secondary?.link || "#portfolio"}>
                    ...
                    <p className="text-[12.5px] text-[#64748B] font-medium tracking-tight">
                  ...
                  <div className="mt-auto pt-4">
                    <div className="trust-pills flex flex-wrap gap-3 mb-6">
                      {(hero.content_json?.certificates || []).map((c: any, i: number) => (
                        <span key={i} className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-50 border border-[#CBD5E1] text-[12.5px] font-semibold text-[#475569] hover:border-[#2563EB]/40 transition-all shadow-sm">
                    ...
                    <div>
                      <a href={hero.content_json?.trusted_block?.link || "#testimonials"} className="inline-flex items-center gap-3.5 group/rated hover:opacity-90 transition-all bg-slate-50 border border-[#CBD5E1] px-4 py-2.5 rounded-2xl w-full sm:w-auto shadow-sm">
                         ...
                         <div className="flex flex-col">
                            <div className="flex items-center gap-2">
                               ...
                               <span className="text-[12px] text-[#475569]">{hero.content_json?.trusted_block?.rating_text || 'Rated 5.0'}</span>
                            </div>
                            <span className="text-[13px] text-[#1E293B] font-bold tracking-tight">Trusted by <strong className="text-[#15803D]">{hero.content_json?.trusted_block?.trust_text || '75+ businesses'}</strong> worldwide</span>
                         </div>
                      </a>
                    </div>
                  </div>
                ...
                <div className="w-full flex flex-col gap-5 animate-in fade-in slide-in-from-right-8 duration-700 delay-200">
                  ...
                  <div className="hero-certs pt-2">
                    <span className="block text-[11px] font-extrabold tracking-[0.15em] uppercase text-[#64748B] mb-3">Certified &amp; Partnered with</span>
                    <div className="cert-row flex flex-wrap gap-2.5">
                      {[
                        { label: "Google Ads", icon: <svg viewBox="0 0 24 24" width="22" height="22"><path d="M21.35 11.1h-9.17v2.73h6.51c-.33 3.81-3.5 5.44-6.5 5.44C8.36 19.27 5 12c0-4.1 3.2-7.27 7.2-7.27 3.09 0 4.44 1.76 4.44 1.76l2.04-2.1S16.46 2 12 2C6.48 2 2 6.48 2 12s4.48 10 10 10c7.06 0 10-4.95 10-10 0-.67-.04-1.35-.65-.9z" fill="#4285F4"/></svg>, color: "rgba(66, 133, 244, 0.05)" },
                        { label: "Google Analytics", color: "rgba(249, 171, 0, 0.05)", svg: <svg viewBox="0 0 24 24" width="14" height="14"><rect x="4" y="13" width="4" height="7" rx="1" fill="#F9AB00"/><rect x="10" y="8" width="4" height="12" rx="1" fill="#F9AB00"/><rect x="16" y="3" width="4" height="17" rx="1" fill="#F9AB00"/></svg> },
                        { label: "Tag Manager", color: "rgba(66, 133, 244, 0.05)", svg: <svg viewBox="0 0 24 24" width="14" height="14"><path d="M12.5 3H6a2 2 0 0 0-2 2v6.5a2 2 0 0 0 .586 1.414l7.5 7.5a2 2 0 0 0 2.828 0l6.5-6.5a2 2 0 0 0 0-2.828l-7.5-7.5A2 2 0 0 0 12.5 3z" fill="#4285F4"/><circle cx="8" cy="8" r="1.6" fill="#fff"/></svg> },
                        { label: "WordPress", color: "rgba(33, 117, 155, 0.05)", svg: <svg viewBox="0 0 24 24" width="20" height="20" fill="#21759B"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm.12 17.55c-2.07 0-3.95-.73-5.43-1.95l2.67-7.75c.21-.57.36-1 .36-1 0-.12-.06-.21-.21-.21-.06 0-.6.09-.9.09h-.18l.12-.48.9-.03c.57-.03 1.23-.03 1.23-.03l.93.03.48.03-.12.48c-.09 0-.21 0-.39 0-.24 0-.48.06-.63.24-.15.21-.24.48-.36.87l-2.04 6 1.35-4.11 1.29 3.63zm3.72-3.12c1-.48 1.68-1.5 1.68-2.61 0-.78-.36-1.53-1.02-2.1-.66-.57-1.32-.81-1.32-.81 0-.09.09-.15.18-.15.15 0 .39.03.6.03.66 0 1.23-.09 1.23-.09l-.12-.48c-.36-.03-1.11-.03-1.11-.03l-1.05.03c-.27 0-.54.03-.84.03-.42 0-1.11-.03-1.11-.03l.12.48s.51.03.78.03c.36 0 .57.18.57.57 0 .21-.09.48-.21.84l-2.04 6c-.03.09-.06.18-.06.27l1.98-5.76 1.95 5.82s.06-.06.12-.12c.24-.24.36-.63.36-1.05zm1.5-6.6c.15-.12.27-.12.42-.12.42 0 .81.24.81.63 0 .12 0 .24-.06.33-.18.54-.42.93-.42.93s-.36.21-.84.21c-.42 0-.69-.15-.84-.15s-.27.06-.27.06-.18.24-.24.33c-.15.21-.27.42-.27.42l-.57 1.65c-.09.24-.21.57-.21.87 0 .39.15.69.45.69.18 0 .42-.06.42-.06l.12-.48s-.15.03-.24.03c-.12 0-.21-.06-.21-.21s.03-.18.09-.33l.42-1.11 1.14-3.3c.03-.09.09-.12.18-.12zm-9.06 9.3c-2.43-1.44-4.05-4.14-4.05-7.23 0-.63.15-1.23.39-1.77L8.28 18.21z"/></svg> }
                      ].map((item, idx) => (
                        <span key={idx} className="flex items-center gap-2.5 px-3 py-1.5 rounded-xl border border-[#CBD5E1] bg-slate-50 font-bold text-[12px] text-[#475569] hover:border-[#2563EB]/40 transition-all shadow-sm" style={{ background: item.color || 'transparent' }}>
              ...
              <div className="mt-10 lg:mt-12 pt-8 border-t border-[#CBD5E1] grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-0">
                {(hero.content_json?.hero_stats || [
                  ...
                  <div key={idx} className={`flex flex-col items-center text-center px-4 ${idx !== 3 ? 'md:border-r md:border-[#CBD5E1]' : ''}`}>
                    <strong className={`font-display text-[28px] lg:text-[34px] font-extrabold tracking-tight leading-none mb-1.5 ${stat.highlight || stat.label?.includes('Retention') ? 'text-[#15803D]' : 'text-[#1E293B]'}`}>
                      {stat.value}
                    </strong>
                    <span className="text-[11px] lg:text-[12px] font-extrabold uppercase tracking-wider text-[#64748B]">
                      {stat.label}
                    </span>
                  </div>
                ))}
              ...
              <div className="pointer-events-none absolute inset-x-0 bottom-0 h-24 bg-gradient-to-b from-transparent to-[#FFFFFF] opacity-60" />
            </div>
          </section>
          ...
          <section className="w-full bg-[#F8FAFC] border-b border-[#E2E8F0] relative overflow-hidden" id="testimonials">
            <div className="max-w-[var(--container)] mx-auto px-6 lg:px-10 py-20 relative z-10">
          ...
          <section className="w-full bg-[#FFFFFF] border-b border-[#E2E8F0] relative overflow-hidden" id="certifications">
            <div className="max-w-[var(--container)] mx-auto px-6 lg:px-10 py-20">
              <Reveal className="sec-head max-w-[720px] mb-12">
          ...
          {/* FAQ SECTION */}
          <section className="w-full bg-[#F8FAFC] border-b border-[#E2E8F0] relative overflow-hidden" id="faq">
            <div className="max-w-[var(--container)] mx-auto px-6 lg:px-10 py-20">
              <Reveal className="sec-head max-w-[720px] mb-12">
          ...
          <section className="w-full bg-[#FFFFFF] border-b border-[#E2E8F0] relative overflow-hidden" id="contact">
            <div className="max-w-[var(--container)] mx-auto px-6 lg:px-10 py-20 relative z-10">
              <Reveal className="sec-head max-w-[720px] mb-16">
              ...
              <div className="flex flex-col gap-12">
                {/* Zcal Embed - Clean Light Panel Frame */}
                ...
                <div className="w-full">
                  ...
                  <div className="grid grid-cols-5 max-xl:grid-cols-3 max-md:grid-cols-2 max-sm:grid-cols-1 gap-4">
                    {[
                      ...
                      <div key={i} className="p-5 rounded-2xl border border-[#CBD5E1] bg-white shadow-sm flex flex-col gap-2 hover:border-slate-300 hover:shadow-md transition-all group">
          ...
          <section className="w-full bg-[#F8FAFC] border-b border-[#E2E8F0] relative overflow-hidden">
            <div className="max-w-[var(--container)] mx-auto px-6 lg:px-10 py-20 relative z-10">
                ...
                <div className="space-y-10">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    {[
                      ...
                      <a key={i} className="flex items-center gap-5 p-5 rounded-[24px] border border-[#CBD5E1] bg-white shadow-sm hover:border-[#2563EB]/40 hover:shadow-md transition-all group" href={l.href} target="_blank" rel="noopener">
          ...
          <footer className="site-footer bg-[#F8FAFC] text-center text-[13px] text-[#64748B] py-12 border-t border-[#E2E8F0]">
            <div className="max-w-[var(--container)] mx-auto px-6 lg:px-10">
              <p><strong className="text-[#1E293B]">{settings.business_name}</strong> — {settings.owner_name}, {settings.job_title}. © 2026. Specialized for local service businesses.</p>
            </div>
          </footer>
          ...
          {/* SOCIAL & FOOTER FORM SECTION */}
          <section className="w-full bg-[#F8FAFC] border-b border-[#CBD5E1] relative overflow-hidden">
            <div className="max-w-[var(--container)] mx-auto px-6 lg:px-10 py-20 relative z-10">
              <div className="grid grid-cols-[0.4fr_0.6fr] max-xl:grid-cols-1 gap-16 items-start">
