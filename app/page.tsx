                ...
                <div className="hero-copy flex flex-col justify-between h-full animate-in fade-in slide-in-from-left-8 duration-700">
                  <div>
                    ...
                    <div className="hero-actions flex flex-wrap gap-4 mt-12 mb-2.5 max-sm:flex-col">
                      ...
                      <a className="btn btn-ghost px-8 py-4 text-[15px] font-bold rounded-xl border border-slate-300 bg-white text-[#1E293B] hover:bg-slate-50 transition-all flex items-center gap-2 shadow-sm" href={hero.content_json?.cta_secondary?.link || "#portfolio"}>
