...
export function PulseCard({ content }: PulseCardProps) {
  ...
  return (
    <div className="pulse-card bg-white border border-[#E2E8F0] rounded-[24px] p-6 relative overflow-hidden group shadow-xl transition-all duration-500 hover:border-[#2563EB]/40">
      {/* Background radial glow */}
      <div className="absolute inset-[-40%_-20%_auto_auto] w-[260px] h-[260px] bg-[radial-gradient(circle,rgba(37,99,235,0.06),transparent_70%)] opacity-70 pointer-events-none" />
      
      {/* Interactive Tabs */}
      <div className="flex gap-1.5 p-1 bg-[#F1F5F9] rounded-xl mb-5 relative z-10 border border-[#E2E8F0]">
      ...
      <div className="ad-mockup bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl p-4 mb-5 relative z-10 transition-all duration-300 shadow-sm">
        <div className="flex items-center justify-between gap-1.5 border-b border-[#E2E8F0] pb-2.5 mb-3">
          <span className="text-[9.5px] font-extrabold uppercase tracking-wider text-[#64748B] flex items-center gap-1.5">
          ...
          <span className="px-2 py-0.5 rounded-md bg-emerald-500/10 text-emerald-600 border border-emerald-500/20 text-[9px] font-bold uppercase tracking-wider">
            ● Active
          </span>
        </div>
        ...
        <div className="flex items-start gap-1 mb-1.5">
          <span className="text-[10px] font-extrabold text-[#64748B] border border-[#E2E8F0] px-1 py-0.2 rounded bg-white mr-1.5 mt-0.5 select-none">Ad</span>
          <span className="text-[11px] text-[#475569] truncate">{currentCampaign.url}</span>
        </div>
        
        <h4 className="text-[14px] font-bold text-[#2563EB] leading-snug mb-1.5">
          {currentCampaign.headline}
        </h4>
        
        <p className="text-[11.5px] text-[#475569] leading-normal mb-3">
          {currentCampaign.desc}
        </p>
        
        {/* Dynamic Ad Badges */}
        <div className="flex gap-2 flex-wrap items-center">
          <span className="px-2 py-1 text-[9.5px] font-semibold bg-[#2563EB]/10 text-[#2563EB] rounded border border-[#2563EB]/20">
            ✓ Dynamic Call Swap
          </span>
          ...
          <div className="flex items-center gap-1.5 text-emerald-600 animate-slow-blink bg-emerald-50 px-2 py-1 rounded-md border border-emerald-200">
      ...
      <div className="result-image-box bg-[#F8FAFC] rounded-xl p-2 border border-[#E2E8F0] animate-in fade-in zoom-in-95 duration-500">
         <img 
      ...
      <p className="text-[11px] text-[#64748B] text-center mt-2.5 font-medium tracking-tight">
