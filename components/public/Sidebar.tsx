    ...
    <aside className="sidebar fixed left-0 top-0 w-[var(--sidebar-w)] h-screen bg-[rgba(5,13,26,0.95)] border-r border-[var(--line)] p-7 pb-5.5 flex flex-col justify-between gap-4.5 backdrop-blur-[20px] z-40 overflow-y-auto hidden lg:flex">
      ...
      <div className="side-bottom flex flex-col gap-3">
        ...
        <div className="mini-social flex justify-center gap-2" aria-label="Social links">
          ...
          <a href="https://facebook.com/wphossain374" target="_blank" rel="noopener" className="w-9 h-9 rounded-lg grid place-items-center bg-[rgba(255,255,255,0.03)] border border-[var(--line)] text-[var(--ink-dim)] hover:text-white hover:border-[var(--gold-line)] hover:bg-[var(--gold-soft)] hover:-translate-y-0.5 transition-all">
          ...
          <a href="https://youtube.com/@wphossain" target="_blank" rel="noopener" className="w-9 h-9 rounded-lg grid place-items-center bg-[rgba(255,255,255,0.03)] border border-[var(--line)] text-[var(--ink-dim)] hover:text-white hover:border-[var(--gold-line)] hover:bg-[var(--gold-soft)] hover:-translate-y-0.5 transition-all">
        ...
        <p className="side-email text-[12.5px] text-[var(--ink-faint)] text-center">
          Or email <a href={`mailto:${email}`} className="text-[var(--ink-dim)] font-semibold hover:text-[var(--gold)] transition-colors">{email}</a>
        </p>
      </div>
    </aside>
  );
